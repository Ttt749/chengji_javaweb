...
<head>
    ...
    <script src="${pageContext.request.contextPath}/system/js/showTeacou.js"></script>
</head>
<body>
<%
    ...
    <table class="table table-hover" id="table1">
        ...
        <c:forEach var="stucou" items="${data}">
            <tr>
                ...
                <td>${stucou.cId}</td>
                <td>
                    <button type="button" class="btn btn-info btn-sm" onclick="update('${stucou.tId}','${stucou.cId}')">修改</button>
                    <button type="button" class="btn btn-danger btn-sm" onclick="delet('${stucou.tId},${stucou.cId}')">删除</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<div class="modal fade" id="updateTeacou" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="insertTeacou" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <h3 class="form-title text-center">Update Data</h3>
                    <div class="form-group">
                        <label for="tIdin" class="col-sm-2 control-label">教师id</label>
                        <div class="col-sm-10">
...
<div class="modal fade" id="queryTeacou" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="tIdqu" class="col-sm-2 control-label">教师id</label>
                        <div class="col-sm-10">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-body">
                    确认删除<label id="tcdelete1"></label>-<label id="tcdelete2"></label>>这条信息吗?
                </div>
...
<script>
    function delet(tId,cId) {
        $('#tcdelete1').html(tId);
        $('#tcdelete2').html(cId);
        $('#deleteStucou').modal('show');
    }
    function update(tId,cId) {
        $('#tId').val(tId);
        $('#cId').val(cId);
        $('#updateTeacou').modal('show');
    }
